...
},{"../dist/js/templates.min.js":44,"./app.constants":1,"./app.routes":3,"./modules/extensions/extensions.module":5,"./modules/home/home.module":16,"./modules/mail/mail.module":31,"./modules/oauth/oauth.module":32,"angular":42,"angular-cookie":35,"angular-local-storage":37,"angular-messages":38,"angular-ui-router":41}],3:[function(require,module,exports){
(function() {
    "use strict";
...
},{"./components/modal/modal.factory":4,"angular":42,"angular-bootstrap":34}],6:[function(require,module,exports){
(function() {
    "use strict";
...
},{"./components/compose/compose.component":17,"./components/compose/compose.factory":18,"./components/filters/html2string.filter":19,"./components/inbox/inbox.component":20,"./components/inbox/inbox.factory":21,"./components/message/message.component":22,"./components/sent/sent.component":23,"./components/sent/sent.factory":24,"./components/sidebar/sidebar.component":25,"./components/template/template.component":26,"./components/topbar/topbar.component":27,"./components/trash/trash.component":28,"./components/trash/trash.factory":29,"./mail.component":30,"angular":42,"angular-local-storage":37,"angular-sanitize":39,"angular-summernote":40}],32:[function(require,module,exports){
(function() {
    "use strict";
...
},{"./oauthInterceptor.factory":33,"angular":42}],33:[function(require,module,exports){
(function() {
    "use strict";
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],35:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],36:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],37:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],38:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],39:[function(require,module,exports){
(function (global){
...
; browserify_shim__define__module__export__(typeof angular.module('ngSanitize') != "undefined" ? angular.module('ngSanitize') : window.angular.module('ngSanitize'));

}).call(global, undefined, undefined, undefined, undefined, function defineExport(ex) { module.exports = ex; });

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],40:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],41:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":42}],42:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/jquery/dist/jquery.js":43}],43:[function(require,module,exports){
(function (global){
; var __browserify_shim_require__=require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
/*!
...
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('/partials/mail/components/message/message.view.html', '<div class="at-view-slide-in-left page-content page-app mailbox" style="margin-top:50px;">\n' + '    <section class="app">\n' + '        <div class="email-details" style="display: table-cell;">\n' + '            <section>\n' + '                <div class="email-subject">\n' + '                    <h1 data-ng-class="$ctrl.subjectStyle()">{{$ctrl.viewModel.message.subject}}</h1>\n' + '                    <div class="clearfix">\n' + '                        <p>from <strong><span data-ng-class="$ctrl.senderStyle(message)">{{$ctrl.viewModel.message.from}}</span></strong> \u2022\n' + '                            to <strong><span data-ng-class="$ctrl.senderStyle(message)">{{$ctrl.viewModel.message.to}}</span></strong> \u2022\n' + '                            <span class="date">{{ctrl.viewModel.message.created_at | date}}</span></p>\n' + '                        <a aria-label="Back to {{$ctrl.viewModel.message.typeName}}" class="btn btn-primary btn-sm" \n' + '                            data-toggle="tooltip" data-ui-sref="{{$ctrl.viewModel.returnRoute}}" data-ui-sref-opts="{reload: true}"\n' + '                            style="margin-bottom: 4px;" title="Back to {{$ctrl.viewModel.message.typeName}}">\n' + '                            <i class="fa fa-arrow-left fa-lg pull-left" aria-hidden="true"></i>\n' + '                        </a>\n' + '\n' + '                        <a aria-label="Delete" class="btn btn-primary btn-sm" data-ng-click="$ctrl.deleteMessage()" \n' + '                            data-toggle="tooltip" style="margin-bottom: 4px;" title="Delete">\n' + '                            <i class="fa fa-trash-o fa-lg pull-left" aria-hidden="true"></i>\n' + '                        </a>\n' + '                    </div>\n' + '                </div>\n' + '                <div class="email-details-inner withScroll mCustomScrollbar _mCS_21" data-height="window" data-padding="155" style="font-weight: normal; height: 760px;">\n' + '                    <div class="mCustomScrollBox mCS-light" id="mCSB_21" style="position:relative; height:100%; overflow:hidden; max-width:100%;">\n' + '                        <div class="mCSB_container" style="position:relative; top:0;">\n' + '                            <div class="email-content" data-ng-bind-html="$ctrl.viewModel.message.body" style="margin-left: 0px">\n' + '                            </div>\n' + '                        </div>\n' + '                        <div class="mCSB_scrollTools" style="position: absolute; display: block; opacity: 0;">\n' + '                            <div class="mCSB_draggerContainer">\n' + '                                <div class="mCSB_dragger" style="position: absolute; height: 43px; top: 0px;" oncontextmenu="return false;">\n' + '                                    <div class="mCSB_dragger_bar" style="position: relative; line-height: 43px;"></div>\n' + '                                </div>\n' + '                                <div class="mCSB_draggerRail"></div>\n' + '                            </div>\n' + '                        </div>\n' + '                    </div>\n' + '                </div>\n' + '            </section>\n' + '        </div>\n' + '    </section>\n' + '</div>');
    }
  ]);
}());
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('/partials/mail/components/sent/sent.view.html', '<div class="at-view-slide-in-left page-content page-app mailbox" style="margin-top:50px;">\n' + '    <section class="app">\n' + '        <aside class="aside-md emails-list">\n' + '            <section>\n' + '                <div class="mailbox-page clearfix">\n' + '                    <h1 class="pull-left">Sent Mail</h1>\n' + '                    <div class="append-icon">\n' + '                        <input type="text" class="form-control form-white pull-right" id="email-search" placeholder="Search...">\n' + '                        <i class="icon-magnifier"></i>\n' + '                    </div>\n' + '                </div>\n' + '                <ul class="nav nav-tabs text-left">\n' + '                    <li class="active f-left"><a href="#recent" data-toggle="tab">Recent</a></li>\n' + '                    <!--<li class="f-left"><a href="#alphabetically" data-toggle="tab">Alphabetically</a></li>-->\n' + '                </ul>\n' + '                <div class="tab-content" style="height:776px;">\n' + '                    <div class="tab-pane fade in active" id="recent">\n' + '                        <div class="messages-list withScroll show-scroll mCustomScrollbar _mCS_68" data-padding="180" data-height="window" style="height:735px;">\n' + '                            <div class="mCustomScrollBox mCS-light" id="mCSB_68" style="position:relative; height:100%; overflow:hidden; max-width:100%;">\n' + '                                <div class="mCSB_container" style="position:relative; top:0;">\n' + '                                    <div class="message-item media" data-ng-click="$ctrl.openMessage(message)" data-ng-repeat="message in $ctrl.viewModel.messages">\n' + '                                        <div class="media">\n' + '                                            <img src="img/avatars/avatar3_big.png" alt="avatar 3" width="40" class="sender-img">\n' + '                                            <div class="media-body">\n' + '                                                <div class="sender" data-ng-class="$ctrl.senderStyle(message)">{{message.nickname}}</div>\n' + '                                                <div class="subject">\n' + '                                                    <span data-ng-class="$ctrl.subjectStyle(message)">{{message.subject}}</span>\n' + '                                                    <span class="subject-subtitle-text">{{message.body | html2string}}</span>\n' + '                                                </div>\n' + '                                                <div class="date" data-ng-class="$ctrl.isRead(message)">{{message.createdAt | date}}</div>\n' + '                                            </div>\n' + '                                        </div>\n' + '                                    </div>\n' + '                                </div>\n' + '                                <div class="mCSB_scrollTools" style="position: absolute; display: block;">\n' + '                                    <div class="mCSB_draggerContainer">\n' + '                                        <div class="mCSB_dragger" style="position: absolute; height: 30px; top: 0px;" oncontextmenu="return false;">\n' + '                                            <div class="mCSB_dragger_bar" style="position: relative; line-height: 30px;"></div>\n' + '                                        </div>\n' + '                                        <div class="mCSB_draggerRail"></div>\n' + '                                    </div>\n' + '                                </div>\n' + '                            </div>\n' + '                        </div>\n' + '                    </div>\n' + '                </div>\n' + '            </section>\n' + '        </aside>\n' + '    </section>\n' + '</div>');
    }
  ]);
}());
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('/partials/mail/components/sidebar/sidebar.view.html', '<!-- BEGIN SIDEBAR -->\n' + '<div class="sidebar sidebar-mailbox">\n' + '    <div class="logopanel">\n' + '        <h1>Mail on Rails</h1>\n' + '    </div>\n' + '    <div class="sidebar-inner">\n' + '        <div class="sidebar-top">\n' + '            <a data-ui-sref="mail.compose" data-ui-sref-opts="{reload: true}" class="btn btn-primary btn-compose">Compose</a>\n' + '        </div>\n' + '        <ul class="nav nav-sidebar">\n' + '            <li data-ng-class="$ctrl.setActive(\'inbox\')">\n' + '                <a data-ui-sref="mail.inbox.index" data-ui-sref-opts="{reload: true}">\n' + '                    <span class="pull-right badge badge-primary" style="margin-right:0px;">{{$ctrl.viewModel.inboxCount}}</span>\n' + '                    <i class="icons-office-28"></i>\n' + '                    <span data-translate="inbox">Inbox</span>\n' + '                </a>\n' + '            </li>\n' + '            <li data-ng-class="$ctrl.setActive(\'sent\')">\n' + '                <a data-ui-sref="mail.sent.index" data-ui-sref-opts="{reload: true}">\n' + '                    <span class="pull-right badge badge-primary" style="margin-right:0px;">{{$ctrl.viewModel.sentCount}}</span>\n' + '                    <i class="icons-chat-messages-14"></i>\n' + '                    <span>Sent Mail</span>\n' + '                </a>\n' + '            </li>\n' + '            <!--<li class="tm">\n' + '                <a data-ui-sref="mail.important">\n' + '                    <i class="icons-badges-votes-14"></i>\n' + '                    <span>Important</span>\n' + '                </a>\n' + '            </li>\n' + '            <li class="tm">\n' + '                <a data-ui-sref="mail.draft">\n' + '                    <span class="badge-rounded pull-right">4</span>\n' + '                    <i class="icons-office-13"></i><span>Draft</span>\n' + '                </a>\n' + '            </li>\n' + '            <li class="tm">\n' + '                <a data-ui-sref="mail.spam">\n' + '                    <i class="icons-alerts-05"></i>\n' + '                    <span>Spam</span>\n' + '                </a>\n' + '            </li>-->\n' + '            <li data-ng-class="$ctrl.setActive(\'trash\')">\n' + '                <a data-ui-sref="mail.trash.index" data-ui-sref-opts="{reload: true}">\n' + '                    <span class="pull-right badge badge-primary" style="margin-right:0px;">{{$ctrl.viewModel.trashCount}}</span>\n' + '                    <i class="icons-office-57"></i>\n' + '                    <span>Trash</span>\n' + '                </a>\n' + '            </li>\n' + '        </ul>\n' + '    </div>\n' + '</div>\n' + '<!-- END SIDEBAR -->');
    }
  ]);
}());
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('/partials/mail/components/template/template.view.html', '<data-ui-view></data-ui-view>');
    }
  ]);
}());
(function (module) {
...
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('/partials/mail/components/trash/trash.view.html', '<div class="at-view-slide-in-left page-content page-app mailbox" style="margin-top:50px;">\n' + '    <section class="app">\n' + '        <aside class="aside-md emails-list">\n' + '            <section>\n' + '                <div class="mailbox-page clearfix">\n' + '                    <h1 class="pull-left">Trash</h1>\n' + '                    <div class="append-icon">\n' + '                        <input type="text" class="form-control form-white pull-right" id="email-search" placeholder="Search...">\n' + '                        <i class="icon-magnifier"></i>\n' + '                    </div>\n' + '                </div>\n' + '                <ul class="nav nav-tabs text-left">\n' + '                    <li class="active f-left"><a href="#recent" data-toggle="tab">Recent</a></li>\n' + '                    <!--<li class="f-left"><a href="#alphabetically" data-toggle="tab">Alphabetically</a></li>-->\n' + '                </ul>\n' + '                <div class="tab-content" style="height:776px;">\n' + '                    <div class="tab-pane fade in active" id="recent">\n' + '                        <div class="messages-list withScroll show-scroll mCustomScrollbar _mCS_68" data-padding="180" data-height="window" style="height:735px;">\n' + '                            <div class="mCustomScrollBox mCS-light" id="mCSB_68" style="position:relative; height:100%; overflow:hidden; max-width:100%;">\n' + '                                <div class="mCSB_container" style="position:relative; top:0;">\n' + '                                    <div class="message-item media" data-ng-click="$ctrl.openMessage(message)" data-ng-repeat="message in $ctrl.viewModel.messages">\n' + '                                        <div class="media">\n' + '                                            <img src="img/avatars/avatar3_big.png" alt="avatar 3" width="40" class="sender-img">\n' + '                                            <div class="media-body">\n' + '                                                <div class="sender" data-ng-class="$ctrl.senderStyle(message)">{{message.nickname}}</div>\n' + '                                                <div class="subject">\n' + '                                                    <span data-ng-class="$ctrl.subjectStyle(message)">{{message.subject}}</span>\n' + '                                                    <span class="subject-subtitle-text">{{message.body | html2string}}</span>\n' + '                                                </div>\n' + '                                                <div class="date" data-ng-class="$ctrl.isRead(message)">{{message.createdAt | date}}</div>\n' + '                                            </div>\n' + '                                        </div>\n' + '                                    </div>\n' + '                                </div>\n' + '                                <div class="mCSB_scrollTools" style="position: absolute; display: block;">\n' + '                                    <div class="mCSB_draggerContainer">\n' + '                                        <div class="mCSB_dragger" style="position: absolute; height: 30px; top: 0px;" oncontextmenu="return false;">\n' + '                                            <div class="mCSB_dragger_bar" style="position: relative; line-height: 30px;"></div>\n' + '                                        </div>\n' + '                                        <div class="mCSB_draggerRail"></div>\n' + '                                    </div>\n' + '                                </div>\n' + '                            </div>\n' + '                        </div>\n' + '                    </div>\n' + '                </div>\n' + '            </section>\n' + '        </aside>\n' + '    </section>\n' + '</div>');
    }
  ]);
}());
(function (module) {
...
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('/partials/extensions/components/modal/views/confirm.view.html', '<div class="modal-header">\n' + '    <h3 class="modal-title">Confirm Message</h3>\n' + '</div>\n' + '<div class="modal-body">\n' + '    <div class="alert alert-info" style="margin-bottom:0px">\n' + '        {{message}}\n' + '    </div>\n' + '</div>\n' + '<div class="modal-footer">\n' + '    <button class="btn btn-primary" type="button" data-ng-click="confirm(method)">Confirm</button>\n' + '    <button class="btn btn-alert" type="button" data-ng-click="cancel()">Decline</button>\n' + '</div>');
    }
  ]);
}());
(function (module) {
