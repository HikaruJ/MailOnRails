...
},{"../dist/js/templates.min.js":39,"./app.constants":1,"./app.routes":3,"./modules/extensions/extensions.module":5,"./modules/home/home.module":16,"./modules/mail/mail.module":26,"./modules/oauth/oauth.module":27,"angular":37,"angular-cookie":30,"angular-local-storage":32,"angular-messages":33,"angular-ui-router":36}],3:[function(require,module,exports){
(function() {
    "use strict";
...
},{"./components/modal/modal.factory":4,"angular":37,"angular-bootstrap":29}],6:[function(require,module,exports){
(function() {
    "use strict";
...
},{"./components/compose/compose.component":17,"./components/compose/compose.factory":18,"./components/filters/html2string.filter":19,"./components/inbox/inbox.component":20,"./components/inbox/inbox.factory":21,"./components/inbox/message/message.component":22,"./components/sidebar/sidebar.component":23,"./components/topbar/topbar.component":24,"./mail.component":25,"angular":37,"angular-local-storage":32,"angular-sanitize":34,"angular-summernote":35}],27:[function(require,module,exports){
(function() {
    "use strict";
...
},{"./oauthInterceptor.factory":28,"angular":37}],28:[function(require,module,exports){
(function() {
    "use strict";
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],30:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],31:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],32:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],33:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],34:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],35:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],36:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/angular/angular.min.js":37}],37:[function(require,module,exports){
(function (global){
...
},{"/home/nogi/Development/Rails/mail_on_rails/client/bower_components/jquery/dist/jquery.js":38}],38:[function(require,module,exports){
(function (global){
; var __browserify_shim_require__=require;(function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
/*!
...
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('/partials/mail/components/inbox/message/message.view.html', '<div class="at-view-slide-in-left page-content page-app mailbox" style="margin-top:50px;">\n' + '    <section class="app">\n' + '        <div class="email-details" style="display: table-cell;">\n' + '            <section>\n' + '                <div class="email-subject">\n' + '                    <h1 data-ng-class="$ctrl.subjectStyle()">{{$ctrl.viewModel.message.subject}}</h1>\n' + '                    <div class="clearfix">\n' + '                        <div class="go-back-list">\n' + '                            <i data-rel="tooltip" data-placement="bottom" data-original-title="Back to email list" class="icon-arrow-left"></i>\n' + '                        </div>\n' + '                        <p>from <strong><span data-ng-class="$ctrl.senderStyle(message)">{{$ctrl.viewModel.message.from}}</span></strong> \u2022 <span class="date">{{ctrl.viewModel.message.created_at | date}}</span></p>\n' + '                        <a aria-label="Back to inbox" class="btn btn-primary btn-sm" \n' + '                            data-toggle="tooltip" data-ui-sref="mail.inbox" data-ui-sref-opts="{reload: true}" style="margin-bottom: 4px;" title="Back to inbox">\n' + '                            <i class="fa fa-arrow-left fa-lg pull-left" aria-hidden="true"></i>\n' + '                        </a>\n' + '                    </div>\n' + '                </div>\n' + '                <div class="email-details-inner withScroll mCustomScrollbar _mCS_21" data-height="window" data-padding="155" style="font-weight: normal; height: 760px;">\n' + '                    <div class="mCustomScrollBox mCS-light" id="mCSB_21" style="position:relative; height:100%; overflow:hidden; max-width:100%;">\n' + '                        <div class="mCSB_container" style="position:relative; top:0;">\n' + '                            <div class="email-content" data-ng-bind-html="$ctrl.viewModel.message.body" style="margin-left: 0px">\n' + '                            </div>\n' + '                        </div>\n' + '                        <div class="mCSB_scrollTools" style="position: absolute; display: block; opacity: 0;">\n' + '                            <div class="mCSB_draggerContainer">\n' + '                                <div class="mCSB_dragger" style="position: absolute; height: 43px; top: 0px;" oncontextmenu="return false;">\n' + '                                    <div class="mCSB_dragger_bar" style="position: relative; line-height: 43px;"></div>\n' + '                                </div>\n' + '                                <div class="mCSB_draggerRail"></div>\n' + '                            </div>\n' + '                        </div>\n' + '                    </div>\n' + '                </div>\n' + '            </section>\n' + '        </div>\n' + '    </section>\n' + '</div>');
    }
  ]);
}());
